...
```sh
go get github.com/kisrobot/amazon-pay-sdk-go
```

## Usage

```go
import amazonpay "github.com/kisrobot/amazon-pay-sdk-go"
...
After placed orders, you can manage them via [our admin interface]((https://demo.getqor.com/admin)), like `take auth`, `capture`, `refund` orders, the admin interface is generated with [QOR Admin](http://github.com/kisrobot/admin)

#### Source code of this demo

[https://github.com/kisrobot/qor-example](https://github.com/kisrobot/qor-example)
